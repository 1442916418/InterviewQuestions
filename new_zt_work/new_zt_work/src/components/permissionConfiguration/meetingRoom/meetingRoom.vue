...
<template>
  <div class="meetingRoom-box">
    <div class="meetingRoom-header">
      ...
      <div class="header-right">
        <Input
          ...
          :placeholder="$t('tip.addMeetingRoomNmae')"
          @keyup.enter.native="queryDataName"
        />
      </div>
    </div>
    <div class="meetingRoom-body">
      <DefaultTable
        :isPage="true"
        :isSelection="false"
    ...
    <Modal width="350" v-model="isShowAddData" :title="$t('tip.meetingRoomName')">
      <div class="add-box">
        <p>{{ $t('tip.addMeetingRoomNmae') }}</p>
        <Input v-model.trim="addData.name" clearable :placeholder="$t('tip.addMeetingRoomNmae')" />
      </div>
