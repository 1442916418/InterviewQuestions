...
<template>
  <div class="instrumentProcessLog-box">
    <div class="instrumentProcessLog-header">
    ...
    <div class="instrumentProcessLog-body">
      <DefaultTable
        :isPage="true"
        :isSelection="false"
...
.instrumentProcessLog-box {
  .single-page-container;

  .instrumentProcessLog-header {
    .header;
