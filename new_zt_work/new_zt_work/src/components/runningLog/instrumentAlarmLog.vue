...
<template>
  <div class="instrumentAlarmLog-box">
    <div class="instrumentAlarmLog-header">
    ...
    <div class="instrumentAlarmLog-body">
      <DefaultTable
        :isPage="true"
        :isSelection="false"
...
.instrumentAlarmLog-box {
  .single-page-container;

  .instrumentAlarmLog-header {
    .header;
